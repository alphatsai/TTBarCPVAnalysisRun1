...
void results(TFile* f, string output="."){
    ...
    drawStack( f, "Evt_O3",    "O_{3}^{e+#mu}/M_{top}^{3}", "Events", output, 1, false );
    drawStack( f, "Evt_O3",    "O_{3}^{e+#mu}/M_{top}^{3}", "Events", output, 1, true );
    drawStack( f, "Evt_O4",    "O_{4}^{e+#mu}/M_{top}^{3}", "Events", output, 1, false );
    drawStack( f, "Evt_O4",    "O_{4}^{e+#mu}/M_{top}^{3}", "Events", output, 1, true );
    ...
    drawStack( f, "Evt_O3_Mu", "O_{3}^{#mu}/M_{top}^{3}",   "Events", output, 1, false );
    drawStack( f, "Evt_O3_Mu", "O_{3}^{#mu}/M_{top}^{3}",   "Events", output, 1, true );
    drawStack( f, "Evt_O4_Mu", "O_{4}^{#mu}/M_{top}^{3}",   "Events", output, 1, false );
    drawStack( f, "Evt_O4_Mu", "O_{4}^{#mu}/M_{top}^{3}",   "Events", output, 1, true );
    ...
    drawStack( f, "Evt_O3_El", "O_{3}^{e}/M_{top}^{3}",     "Events", output, 1, false );
    drawStack( f, "Evt_O3_El", "O_{3}^{e}/M_{top}^{3}",     "Events", output, 1, true );
    drawStack( f, "Evt_O4_El", "O_{4}^{e}/M_{top}^{3}",     "Events", output, 1, false );
    drawStack( f, "Evt_O4_El", "O_{4}^{e}/M_{top}^{3}",     "Events", output, 1, true );
    ...
    drawStack( f, "Evt_Top_Hadronic_Mass", "M_{bqq}^{top}", "Events", output, 10, true );
    drawStack( f, "Evt_Top_Hadronic_Mass", "M_{bqq}^{top}", "Events", output, 10, false );
