...
namespace{
    ...
    double Obs4( TVector3 isoLep, TVector3 hardJet, TVector3 b,   TVector3 bbar, int charge=1 );
    double Obs7( TVector3 beam,   TVector3 b,       TVector3 bbar               );
    double Obs3( TLorentzVector isoLep, TLorentzVector hardJet, TLorentzVector b, TLorentzVector bbar, int charge=1 ); // need boost to bb~ CM
