...
process = cms.Process("bbarTagEff")
...
process.bbarTagEff = cms.EDAnalyzer('bbarTagEff',
    MaxEvents             = cms.int32(options.MaxEvents),
    ReportEvery           = cms.int32(options.reportEvery),  
    InputTTree            = cms.string(options.ttreedir+'/root'),
    #InputFiles            = cms.vstring(FileNames), 
    InputFiles            = cms.vstring('file:OnLxpus/08Sep_MC_NoChi2Cut_Tree/TTJets_SemiLeptMGDecays.root'), 
    #InputFiles            = cms.vstring('file:OnLxpus/08Sep_MC_NoChi2Cut_Tree/TTJets_FullLeptMGDecays.root'), 
    #InputFiles            = cms.vstring('file:OnLxpus/08Sep_MC_NoChi2Cut_Tree/T_t-channel.root'), 
    #InputFiles            = cms.vstring('file:OnLxpus/08Sep_MC_NoChi2Cut_Tree/Tbar_t-channel.root'), 
    #InputFiles            = cms.vstring('file:OnLxpus/08Sep_MC_NoChi2Cut_Tree/Tbar_t-channel.root'), 
    #InputFiles            = cms.vstring('file:OnLxpus/08Sep_MC_NoChi2Cut_Tree/WJetsToLNu.root'), 
    #InputFiles            = cms.vstring('file:OnLxpus/08Sep_MC_NoChi2Cut_Tree/WZ.root'), 
    #InputFiles            = cms.vstring('file:OnLxpus/08Sep_MC_NoChi2Cut_Tree/WW.root'), 
...
process.p = cms.Path(process.bbarTagEff)
