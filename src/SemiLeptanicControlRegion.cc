...
#include "TTBarCPV/TTBarCPVAnalysisRun1/interface/SemiLeptanicControlRegion.h" 
...
//
SemiLeptanicControlRegion::SemiLeptanicControlRegion(const edm::ParameterSet& iConfig) : 
...
SemiLeptanicControlRegion::~SemiLeptanicControlRegion()
{ 
    delete chain_;
}
...
// ------------ Other function -------------
    template<class TH1>
void SemiLeptanicControlRegion::setCutFlow( TH1* h )
{
    if( isSkim_ )
    {
    ...
    template<class TH1>
void SemiLeptanicControlRegion::setLeptonSelHist( TH1* h )
{
...
void SemiLeptanicControlRegion::beginJob()
{
...
void SemiLeptanicControlRegion::analyze(const edm::Event& iEvent, const edm::EventSetup& iSetup)
{ 
    using namespace edm;
    using namespace std;
    ...
    for(int entry=0; entry<maxEvents_; entry++)
    {
        ...
        if( isGoodMuonEvt || isGoodElectronEvt )
        {
            ...
            // CP-Even
            double Oa = Obs4( isoLep.P3, TopNonBJet1.P3, b_jet.P3, bbar_jet.P3 );
            double Ob = Obs2( isoLep.P3, TopNonBJet1.P3, b_jet.P3, bbar_jet.P3, isoLep.Charge );
            // CP-Odd
...
void SemiLeptanicControlRegion::endJob(){
    std::cout<<">> [INFO] End of Job!"<<endl;
}

// ------------ method fills 'descriptions' with the allowed parameters for the module  ------------
void SemiLeptanicControlRegion::fillDescriptions(edm::ConfigurationDescriptions& descriptions){
...
DEFINE_FWK_MODULE(SemiLeptanicControlRegion);
